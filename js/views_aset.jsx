...
function AstRuang() {
  ...
  const [pending, setPending] = useState([{ id: 1, pemohon: "BEM Universitas", ruang: "Aula FST", tanggal: "27 Jun 2026", jam: "08:00–16:00", keperluan: "Seminar Nasional" }]);
  const [form, setForm] = useState(false);
...
Object.assign(window, {
  AstDashboard, AstInventaris, AstKategori, AstLokasi, AstLabel,
  AstPemeliharaan, AstMutasi, AstOpname, AstRuang,
  AstPenyusutan, AstPenghapusan, AstBHP, AstPermintaan, AstDistribusi,
});
