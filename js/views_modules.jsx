// ============================================================
// AIS — Halaman publik MODUL (levelling L1 → L2 → L3)
  ...
  return (
    <div className="lp mp">
      ...
      <section className="lp-final" style={{ marginTop: 24 }}>
        ...
        <button className="btn lp-big" onClick={onLogin} style={{ background: "#fff", color: "var(--orange-600)" }}><Icon name="lock" size={17} /> Masuk ke Portal</button>
      </section>

      <footer className="lp-foot">
        <div className="lp-brand"><div className="sb-logo" style={{ width: 34, height: 34, fontSize: 16 }}>A</div><span style={{ fontWeight: 700 }}>AIS — Sistem Informasi Akademik</span></div>
