  ...
  function save() {
    ...
    if (form.mode === "create") {
      setRows((l) => [{
        ...
        tgl: "05 Jul 2026", iso: "2026-07-05", penulis: "Humas Universitas", baca: Math.max(1, Math.round(body.join(" ").length / 900)),
  ...
  function save() {
    ...
    if (form.mode === "create") {
      setRows((l) => [...l, {
        ...
        penyelenggara: d.penyelenggara || "Universitas", kuota: +d.kuota || 100, terdaftar: 0, biaya: d.biaya, img: HMS_GRAD[d.img],
...
Object.assign(window, { HumasBerita, HumasEvent, HumasKategori });
