...
function HumasBerita() {
  ...
  const blank = { judul: "", ringkas: "", kategori: kats[0] ? kats[0].nama : "Prestasi", penulis: "Humas Universitas", tgl: "05 Jul 2026", img: "blue", unggulan: false, status: "Draf", tags: "", bodyText: "" };
  ...
  function save() {
    ...
    const rec = {
      judul: d.judul.trim(), ringkas: d.ringkas.trim(), kategori: d.kategori, penulis: d.penulis || "Humas Universitas",
...
Object.assign(window, { HumasBerita });
