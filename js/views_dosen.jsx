...
function StaffHero({ persona, role, sub, action }) {
  ...
  return (
    <div className="card staff-hero" style={{ marginBottom: 22, overflow: "hidden", position: "relative", background: `linear-gradient(120deg, #fff, ${meta.bg})`, border: `1px solid ${meta.bg}` }}>
