...
window.AIS_CONTENT = (function () {
  ...
  const berita = [
    {
      id: "akreditasi-unggul", judul: "Universitas Raih Akreditasi Unggul dari BAN-PT",
      ringkas: "Pencapaian tertinggi dalam sejarah institusi — seluruh sembilan kriteria memenuhi standar Unggul.",
      kategori: "Prestasi", tgl: "22 Jun 2026", iso: "2026-06-22", penulis: "Humas Universitas", baca: 4, views: 3420, img: G.blue, unggulan: true,
      tags: ["Akreditasi", "BAN-PT", "Mutu"],
      body: [
        P("Universitas resmi menyandang predikat Akreditasi Unggul dari Badan Akreditasi Nasional Perguruan Tinggi (BAN-PT) untuk periode 2026–2031. Keputusan ini menempatkan institusi pada jajaran perguruan tinggi terbaik di tingkat nasional."),
        ...
        P("Ke depan, universitas menargetkan akreditasi internasional untuk sejumlah program studi unggulan serta memperluas kerjasama riset lintas negara."),
      ],
    },
    {
    ...
    },
    {
      ...
      tags: ["BRIN", "Riset", "MoU"],
      body: [
        P("Universitas dan Badan Riset dan Inovasi Nasional (BRIN) menandatangani nota kesepahaman kerjasama riset di bidang kecerdasan buatan dan big data. Kolaborasi ini mencakup penelitian bersama, pertukaran periset, dan akses fasilitas laboratorium."),
    ...
    {
      id: "mou-utm", judul: "Universitas Jalin Kerjasama dengan Universiti Teknologi Malaysia",
      ...
      body: [
        P("Universitas menandatangani perjanjian kerjasama (MoA) dengan Universiti Teknologi Malaysia. Ruang lingkup kerjasama mencakup pertukaran mahasiswa dan dosen, program joint degree, serta riset kolaboratif."),
  ...
  const events = [
    {
      ...
      deskripsi: "Peringatan hari jadi ke-68 universitas yang menampilkan sidang terbuka senat, orasi ilmiah, penganugerahan penghargaan sivitas, dan ramah tamah.",
    ...
    },
    {
      ...
      tgl: "05 Apr 2026", iso: "2026-04-05", waktu: "07:00 – 17:00 WIB", lokasi: "Kompleks Olahraga Kampus", penyelenggara: "BEM Universitas",
