...
function Beasiswa() {
  ...
  const [openBs, setOpenBs] = useState<(typeof D.beasiswa)[number] | null>(null);
  const [checks, setChecks] = useState<Record<number, boolean>>({});
  const [registered, setRegistered] = useState<Record<string, boolean>>({});
  const [bukti, setBukti] = useState<(typeof D.beasiswa)[number] | null>(null);
...
export { Kalender, Beasiswa, Bantuan };
