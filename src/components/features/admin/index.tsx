...
function AdminDashboard({ nav }) {
  const R = AIS_ROLES; const p = R.personas.admin;
...
function AdminUsers() {
  const R = AIS_ROLES; const toast = useToast();
...
function AdminServices() {
  ...
  const [detail, setDetail] = useState<(typeof R.services)[number] | null>(null);
