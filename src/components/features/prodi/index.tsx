...
function ProdiJadwal() {
  ...
  const grid = {
    "Senin-08:00": { mk: "Pemrograman Mobile", k: "6A", r: "FST-301", t: "blue", bentrok: false },
    "Selasa-08:00": { mk: "RPL", k: "4A", r: "FST-305", t: "green", bentrok: false },
    ...
    "Kamis-10:00": { mk: "Keamanan Informasi", k: "6A", r: "FST-302", t: "purple", bentrok: false },
    "Jumat-08:00": { mk: "Komputasi Awan", k: "6A", r: "FST-303", t: "amber", bentrok: false },
  };
  return (
    <div className="anim-in">
            ...
            <tbody>
              {items.map((it) => (
                <tr key={it.label}>
                  ...
                  <td style={{ textAlign: "center" }} className="mono">{formatNumber(it.total)}</td>
                  <td style={{ textAlign: "center" }} className="mono">{formatNumber(sync && it.status === "warn" ? it.total : it.ok)}</td>
