/* eslint-disable */
// @ts-nocheck
// Generated from js/views_main.jsx by scripts/port-js-ssot.mjs.
"use client";
...
function Dashboard({ nav, krsState }) {
  ...
  return (
    <div className="anim-in">
      {/* Hero */}
      <div className="card" style={{ marginBottom: 22, overflow: "hidden", position: "relative", background: "linear-gradient(120deg, var(--hero-surface), var(--orange-50))", border: "1px solid var(--hero-border)" }}>
        <div style={{ position: "absolute", right: -40, top: -40, width: 220, height: 220, borderRadius: "50%", background: "radial-gradient(circle, color-mix(in srgb, var(--orange) 18%, transparent), transparent 70%)" }} />
        <div className="card-pad" style={{ display: "flex", alignItems: "center", gap: 22, padding: "30px 30px" }}>
          <div className="sb-ava" style={{ width: 64, height: 64, fontSize: 24, borderRadius: 18, background: "linear-gradient(135deg, var(--orange), color-mix(in srgb, var(--orange) 72%, #fff))", color: "#fff", boxShadow: "0 8px 20px rgba(217,126,52,.3)" }}>{initials(m.nama)}</div>
          <div style={{ flex: 1 }}>
      ...
      {tab === "biodata" && (
        <div className="grid" style={{ gridTemplateColumns: "300px 1fr" }}>
          ...
          <div className="card card-pad" style={{ textAlign: "center", alignSelf: "start" }}>
            <div className="sb-ava" style={{ width: 96, height: 96, fontSize: 36, borderRadius: 28, margin: "8px auto 16px", background: "linear-gradient(135deg, var(--orange), color-mix(in srgb, var(--orange) 72%, #fff))", color: "#fff" }}>{initials(m.nama)}</div>
...
export { Dashboard, Profil, Pembayaran };
