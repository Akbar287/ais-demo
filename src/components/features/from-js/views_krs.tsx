/* eslint-disable */
// @ts-nocheck
// Generated from js/views_krs.jsx by scripts/port-js-ssot.mjs.
"use client";
        ...
        <div className="grid" style={{ gridTemplateColumns: "1fr 320px", alignItems: "start" }}>
          ...
          <div className="grid" style={{ position: "sticky", top: 90 }}>
            ...
            <div className="card card-pad">
              ...
              <div className="prog" style={{ marginBottom: 8 }}><i style={{ width: `${(totalSKS / m.sksMax) * 100}%`, background: totalSKS > m.sksMax ? "var(--red)" : "linear-gradient(90deg, var(--orange), color-mix(in srgb, var(--orange) 72%, #fff))", transition: "width .3s" }} /></div>
