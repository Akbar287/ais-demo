...
export function Icon({ name, size = 20, className = "", style = {} }: IconProps) {
  ...
  const paths: Record<string, ReactNode> = {
    ...
    sun: <><circle {...P} cx="12" cy="12" r="4" /><path {...P} d="M12 2.5v2M12 19.5v2M4.6 4.6 6 6M18 18l1.4 1.4M2.5 12h2M19.5 12h2M4.6 19.4 6 18M18 6l1.4-1.4" /></>,
    moon: <><path {...P} d="M20.5 14.5A8.5 8.5 0 0 1 9.5 3.5 7 7 0 1 0 20.5 14.5Z" /></>,
  };
  return (
