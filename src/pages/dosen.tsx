// @ts-nocheck
const { React, useState, useEffect, useRef, Icon, useToast, Modal, Badge, PageHead, Barcode, ImgPlaceholder, rupiah, initials } = window as any;
...
function StaffHero({ persona, role, sub, action }) {
  ...
  return (
    <div className="card" style={{ marginBottom: 22, overflow: "hidden", position: "relative", background: `linear-gradient(120deg, #fff, ${meta.bg})`, border: `1px solid ${meta.bg}` }}>
      <div style={{ position: "absolute", right: -40, top: -40, width: 220, height: 220, borderRadius: "50%", background: `radial-gradient(circle, ${meta.color}22, transparent 70%)` }} />
      <div className="card-pad" style={{ display: "flex", alignItems: "center", gap: 22, padding: 30 }}>
...
Object.assign(window, { DosenDashboard, DosenKelas, DosenPresensi, DosenNilai, DosenJadwal, DosenTA, StaffHero, ProfilStaff, buatRoster, KELAS_DIAMPU, BIMBINGAN_TA });
