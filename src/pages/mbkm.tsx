...
function MbkmPendaftar() {
  ...
  function decide(nim, tahap) { setList((l) => l.map((x) => x.nim === nim ? { ...x, tahap } : x)); toast(tahap === "diterima" ? "Mahasiswa diterima di program MBKM" : "Pendaftaran ditolak", tahap === "diterima" ? "ok" : ""); }
  return (
    <div className="anim-in">
